                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InputBox(
                              ...
                              switchBox: (value) {
                                if (value.isNotEmpty) {
                                  notifier.myFocusNode5.requestFocus();
                                } else {
                                  notifier.myFocusNode3.requestFocus();
                                }
                              },
                            ...
                            InputBox(
                              currentBox: 5,
                              controller: notifier.box5,
                              focusNode: notifier.myFocusNode5,
                              switchBox: (value) {
                                if (value.isNotEmpty) {
                                  notifier.myFocusNode6.requestFocus();
                                } else {
                                  notifier.myFocusNode4.requestFocus();
                                }
                              },
                            ...
                            InputBox(
                              currentBox: 6,
                              controller: notifier.box6,
                              focusNode: notifier.myFocusNode6,
                              switchBox: (value) {
                                if (value.isNotEmpty) {
                                  notifier.myFocusNode6.unfocus();
                                } else {
                                  notifier.myFocusNode5.requestFocus();
                                }
                              },
