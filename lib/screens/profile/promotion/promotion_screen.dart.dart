...
import 'package:pent_space/screens/profile/promotion/choose_goal_screen.dart';
      ...
      return Expanded(
        child: Scaffold(
          ...
          floatingActionButton: GestureDetector(
            onTap: () {
              AppUtils.go(const ChooseGoalScreen());
            },
            child: Container(
              width: 28.w,
              height: 5.h,
...
class FeedItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: 2.4.w, vertical: 2.w),
      decoration: BoxDecoration(
        border: Border(
