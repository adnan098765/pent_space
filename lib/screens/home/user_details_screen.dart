...
class UserDetailsScreen extends StatefulWidget {
  ...
  const UserDetailsScreen({Key? key, this.servicedetails}) : super(key: key);
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          cleanUrl('${widget.servicedetails['profile_picture']}'),
                                        ),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        '${widget.servicedetails['business_name'] != null ? widget.servicedetails['business_name'] : widget.servicedetails['full_name']}',
                                        style: TextStyle(
                                          color: AppPallet.textColor,
                                          fontSize: 15.sp,
